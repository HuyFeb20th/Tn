...
var IMGBB_API_KEY = "f20580866c25ba3e4cf065d604ff1fc5";
var MAX_QUIZZES_PER_USER = 3; 
var MAX_QUIZZES_PER_VIP = 7; 
var ADMIN_USERNAME = "huy20022k8";

var RESULT_REMARKS = {
    bad: [ "🗣Alo Vũ à Vũ", "Nhìn cái điểm xong dính c2 Điêu Thuyền mịa luôn🗿", "Hết cứu🤡", "Học hành đỉnh cao thực sự, đúng là 'thiên tài' có khác🐧", "Thôi kiếp này coi như bỏ🙃" ],
    average: [ "Thôi thì cũng có nỗ lực, đồng ý cho qua 👍", "Trộm vía vẫn còn thở được, ko sao, ko sao 😀", "Ủa sao điểm lại ra thế này ta 🌝", "Cũng tàm tạm vừa đủ qua môn rồi😛" ],
    good: [ "Đù vuýp🤯", "Đù, học kiểu đéo gì mà điểm cháy vailon thế☠️", "Làm lại mấy lần rồi mà điểm chất thế💩", "Adu, nay đc gặp học bá luon😬" ]
};

var auth = null;
var db = null;
var isSetupNeeded = false;
var appId = typeof __app_id !== 'undefined' ? __app_id.replace(/\//g, '-') : 'quiz-app-huy-github';
var finalConfig = typeof __firebase_config !== 'undefined' ? JSON.parse(__firebase_config) : MY_FIREBASE_CONFIG;
...
var quizzesPath = `artifacts/${appId}/public/data/quizzes`;
